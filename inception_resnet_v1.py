...
def block35(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    #35x35 resnet bloğunu oluşturur.
...
def block17(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    #17x17 resnet bloğunu oluşturur
...
def _inference(images, keep_probability, phase_train=True,
    ...
    batch_norm_params = {
        #Hareketli öğeler için bozulma oranı
        'decay': 0.995,
        # varyansta 0'ları önlemek için epsilon.
        'epsilon': 0.001,
        # Ortalama ve varyans tahminlerinin anlık güncellemeleri zorlar
